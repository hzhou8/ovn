...
struct lr_lb_nat_data_input {
    ...
    // hzhou: I am not sure if it is a good idea to wrap input data into a
    // structure, but if we do it, at least it should include all the input.
    // This structure is missing lb_data. Is there a particular reason?
};
